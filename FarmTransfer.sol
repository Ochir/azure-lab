...
contract FarmTransfer is WorkbenchBase("FarmTransfer", "FarmTransfer") {
    ...
    function FarmTransfer(address device, string description, uint256 price, uint256 quantity, int mintemp, int maxtemp, uint256 minhumid, uint256 maxhumid) public {
    ...
    function OnTheWay(uint humidity, int temperature, int timestamp) public {      
